...
Each folder represents one major step of the pipeline, from patient cohort selection to model training and result generation.
...
- **`EDA&Feature_selection`**  
  Scripts for exploratory analysis of clinical variables (missing values, distributions, and correlations) and for implementing multiple feature selection pipelines (P1–P6) as well as the full feature set.
